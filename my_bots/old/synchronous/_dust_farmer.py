...
bot_vars.loot.pickup_list    = {'Dust'     : ModelID.Pile_Of_Glittering_Dust,
                                'Remnants' : ModelID.Shadowy_Remnant}
...
def SynchronousLogic():
    ...
    while True:
        ...
        if (bot_vars.do_setup or Map.GetMapID() != Maps.toa) and not bot_vars.handle_inv:
            ...
            sq.Skills.CheckRequirements({'Scythe Mastery' : 9, 'Earth Prayers' : 16, 'Mysticism' : 11})
            sq.Maps.SetMode(0)
